...
<div class="my-12 sm:mt-16 md:mt-12 lg:mt-12">
...
<div class="max-w-7xl mx-auto py-20 sm:py-24 md:py-28" data-reveal>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 sm:gap-5">
        ...
        <div
            class="rounded-3xl sm:rounded-4xl border border-forest/10 bg-white p-5 sm:p-6 flex flex-col gap-4 sm:gap-5"
        >
            <div class="flex items-center">
                @foreach ($trustAvatarPreview as $person)
                    <div
                        class="size-9 sm:size-10 rounded-full border-2 border-white -ml-3 first:ml-0 overflow-hidden shrink-0 relative bg-lime/15"
                    >
                        ...
                        @else
                            <div
                                class="absolute inset-0 flex items-center justify-center text-lime font-agency font-bold text-xs"
                                aria-hidden="true"
                            >
                ...
                @endforeach
                <div
                    class="size-9 sm:size-10 rounded-full border-2 border-white -ml-3 bg-forest text-cream flex items-center justify-center font-agency font-bold text-xs shrink-0"
                >
                    85+
                </div>
            </div>
        ...
        <div
            class="md:row-span-2 rounded-3xl sm:rounded-4xl bg-forest-deep p-6 sm:p-8 flex flex-col gap-5 sm:gap-6 relative overflow-hidden min-h-96 md:min-h-0"
        >
            <i
                class="fi fi-sr-quote-right absolute -top-3 right-5 sm:right-7 text-6xl sm:text-7xl text-white/5 pointer-events-none"
                aria-hidden="true"
            ></i>
        ...
        {{-- 80%+ repeat clients, same verified stat used in the Why
             Wavesync marquee --}}
        <div
        ...
        <div
            class="rounded-3xl sm:rounded-4xl border border-forest/10 bg-white p-5 sm:p-6 flex flex-col gap-3 sm:gap-4 justify-between min-h-44 sm:min-h-0"
        >
            <div class="flex flex-col gap-1">
                <h4 class="font-agency font-bold text-forest text-lg sm:text-xl">450+ global project</h4>
        ...
        {{-- 95%+ client satisfaction, same verified stat used in the Why
             Wavesync marquee --}}
        <div
            class="rounded-3xl sm:rounded-4xl border border-forest/10 bg-white p-5 sm:p-6 flex flex-col justify-end gap-2 sm:gap-3 min-h-44 sm:min-h-0"
        >
            <span class="font-agency font-extrabold text-forest text-4xl sm:text-5xl leading-none">95%+</span>
            <p class="text-forest/60 text-sm leading-relaxed">Client Satisfaction</p>
        </div>

        {{-- 150+ real clients, real client logos in place of the
                 reference's stock avatar cluster --}}
        <div
            class="md:col-span-2 rounded-3xl sm:rounded-4xl bg-linear-to-br from-lime/20 to-mist border border-forest/10 p-6 sm:p-8 flex items-center justify-between gap-6 min-h-40 sm:min-h-0"
        >
            <div class="flex flex-col gap-1">
            ...
            <div class="hidden sm:flex items-center shrink-0">
                @foreach ($trustClientLogos as $client)
                    <div
                        class="size-12 sm:size-14 rounded-full bg-white border-2 border-mist -ml-4 first:ml-0 shrink-0 flex items-center justify-center overflow-hidden shadow-sm"
                    >
                        <img
                            src="{{ $client['logo'] }}"
                            alt="{{ $client['name'] }}"
