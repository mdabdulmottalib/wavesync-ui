    ...
    'highlights' => [
        [
            ...
            'deliverables' => [
                ...
                ['title' => 'Design Systems', 'desc' => 'A reusable library of components — buttons, cards, states — so new screens get built consistently instead of redesigned from scratch each time.'],
                ['title' => 'Developer Handoff', 'desc' => 'Specs, redlines, and exported assets prepared so what gets built matches what got designed, not lost in translation.'],
            ],
        ...
        [
            ...
            'deliverables' => [
                ...
                ['title' => 'Database Design', 'desc' => "Schema designed for how the data actually gets used and how the application will grow, not just what's convenient to build first."],
                ['title' => 'Automated Testing', 'desc' => "Test coverage written for the logic that actually needs to be correct, so changes later don't quietly break what already works."],
            ],
        ...
        [
            ...
            'deliverables' => [
                ...
                ['title' => 'Security Hardening', 'desc' => "Core, theme, and plugin updates kept current, login access locked down, and backups configured so the site isn't one abandoned plugin away from a problem."],
                ['title' => 'Site Migration', 'desc' => 'Moving an existing WordPress site to new hosting or a new theme without losing content, SEO rankings, or uptime along the way.'],
            ],
        ...
        [
            ...
            'deliverables' => [
                ...
                ['title' => 'Logo Variations & Iconography', 'desc' => "Secondary marks, favicon versions, and app icons built alongside the primary logo, so the identity holds up in every size and context it'll actually appear in."],
                ['title' => 'Brand Asset Library', 'desc' => "Every file organized and exported in the formats you'll actually need — print-ready, web-ready, source files — so nothing's a scramble to track down later."],
            ],
        ...
        [
            ...
            'deliverables' => [
                ...
                ['title' => 'Marketing Collateral', 'desc' => 'One-pagers, sales sheets, and brochures built to support a sales conversation, not just sit in a folder unread.'],
                ['title' => 'Email & Newsletter Design', 'desc' => 'Templates for newsletters and campaign emails that stay on-brand and render properly across inboxes, not just in a browser preview.'],
            ],
        ...
        [
            ...
            'deliverables' => [
                ...
                ['title' => 'User Research & Testing', 'desc' => 'Real users walked through key flows before and after design changes, so decisions are based on how people actually behave, not assumptions.'],
                ['title' => 'Empty States & Edge Cases', 'desc' => 'The screens most products forget — no data yet, errors, permission limits — designed with the same care as the primary flow.'],
            ],
        ...
        [
            ...
            'deliverables' => [
                ...
                ['title' => 'Meta & Instagram Ads Management', 'desc' => 'Day-to-day campaign management — bid adjustments, budget shifts, creative rotation — instead of a set-and-forget launch.'],
                ['title' => 'A/B Testing', 'desc' => "Creative and targeting variations tested against each other, so decisions are based on what the audience actually responds to, not a guess."],
            ],
        ...
        [
            ...
            'deliverables' => [
                ...
                ['title' => 'Keyword & Content Strategy', 'desc' => 'The specific searches worth targeting, prioritized by what a business can realistically rank for and what those searches are actually worth.'],
                ['title' => 'Site Speed Optimization', 'desc' => 'Load-time fixes handled as their own project, since a slow site holds back both rankings and conversions regardless of how good the content is.'],
            ],
        ...
        [
            ...
            'deliverables' => [
                ...
                ['title' => 'AI Search Audit', 'desc' => "A check of how a business currently shows up (or doesn't) across ChatGPT, Perplexity, and Google's AI Overviews, before any changes get made."],
                ['title' => 'FAQ & Knowledge Structuring', 'desc' => 'Content organized around the direct questions customers actually ask, in a format AI tools can parse and quote cleanly.'],
            ],
        ...
        [
            ...
            'deliverables' => [
                ...
                ['title' => 'Self-Hosted Setup', 'desc' => 'n8n hosted on infrastructure you control, not a third-party account that can change terms or pricing later.'],
                ['title' => 'Ongoing Workflow Maintenance', 'desc' => "Workflows revisited as your tools or process change, so an automation doesn't quietly stop working after an API update."],
            ],
        ...
        [
            ...
            'deliverables' => [
                ...
                ['title' => 'Access Scoping & Permissions', 'desc' => "What the agent can and can't touch defined explicitly upfront, reviewed before it's given access to anything real."],
                ['title' => 'Task Monitoring & Handoff', 'desc' => "Early runs watched closely for mistakes before the agent is trusted to run unsupervised."],
            ],
        ...
        [
            ...
            'deliverables' => [
                ...
                ['title' => 'Multi-Agent Coordination', 'desc' => 'Multiple agents handling different parts of a task and handing off between each other, instead of one agent trying to do everything.'],
                ['title' => 'Ongoing Review & Refinement', 'desc' => "Performance checked as the agent accumulates experience, with memory and workflows adjusted based on what's actually working."],
            ],
